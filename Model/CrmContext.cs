...
namespace Context
{
	...
	public partial class CrmContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="Context.Account"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Context.Account> AccountSet
		{
			get
			{
				return this.CreateQuery<Context.Account>();
			}
		}
	}
